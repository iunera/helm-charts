...
{{ include "images.image" (dict "imageRoot" .Values.metrics.image "global" .Values.global) }}
{{- end -}}
...
{{ include "images.image" (dict "imageRoot" .Values.externalAccess.autoDiscovery.image "global" .Values.global) }}
{{- end -}}
...
{{ include "images.image" (dict "imageRoot" .Values.tls.image "global" .Values.global) }}
{{- end -}}
...
{{ include "images.pullSecrets" (dict "images" (list .Values.image .Values.metrics.image .Values.volumePermissions.image) "global" .Values.global) }}
{{- end -}}
